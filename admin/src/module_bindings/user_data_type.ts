...
export namespace UserData {
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: UserData): void {
    UserData.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): UserData {
    return UserData.getTypeScriptAlgebraicType().deserialize(reader);
  }
